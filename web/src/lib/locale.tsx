...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'diag.form.repo_placeholder': 'owner/repo',
    'diag.form.run_id': 'Run ID',
    'diag.form.run_id_placeholder': 'GitHub workflow_run.id',
    'diag.form.run_attempt': 'Run Attempt',
    'diag.form.tier': 'Tier',
    'diag.form.tier_default': 'Default (Haiku — fast + cheap)',
    'diag.form.tier_deep': 'Deep (Sonnet — more accurate)',
    'diag.form.submit': 'Diagnose',
    'diag.form.submitting': 'Diagnosing...',
    'diag.form.help': 'Paste a GitHub Actions run URL to auto-fill, or enter manually.',
  ...
  zh: {
    ...
    'diag.form.tier': '分析层级',
    'diag.form.tier_default': '默认（Haiku — 快速低成本）',
    'diag.form.tier_deep': '深度（Sonnet — 更准确）',
    'diag.form.submit': '开始诊断',
    'diag.form.submitting': '诊断中...',
    'diag.form.help': '可粘贴 GitHub Actions run URL 自动填充，或手动输入。',
